  ...
  return (
    <>
      <div className={styles.textBox}>
        ...
        <h3>シャンテン数とは？</h3>
        <p>
          テンパイまで最短であと何巡必要か、という値のことをシャンテン数と言います。例えば、以下の手牌では、次巡に索子の3（竹が3つ描かれている牌）か筒子の3（丸が3つ描かれている牌）を持ってきて、中を捨てればテンパイできるので、1シャンテン（イーシャンテン）であると言えます。
        </p>
        <img
        ...
        <h3>七対子（チートイツ）とは？</h3>
        <p>
          麻雀は役がないとアガることができないという話を先ほどしましたが、立直以外にも役はあって、その一つが七対子です。七対子とは読んで字の如く、対子を7個揃えると成立します。覚えるのがとても簡単で、実戦でも高打点を作りたいときに狙います。また一般的には、対子が4つ（七対子の2シャンテン）から、4面子1雀頭揃える手順と七対子に向かう手順のバランスを取るとよいとされています。
        </p>
        <h2>一人麻雀について</h2>

        <ul>
          <li>
            牌を18巡ツモって、流局までにアガれたら+8000点、アガれなくても流局時に聴牌していたら+1000点、イーシャンテンでも+500点となっています。実戦では流局時にイーシャンテンでも点数はもらえないのですが、一人麻雀はパズルとして楽しんでほしいので、シャンテン数を進めたということで、点数がもらえます。
          </li>
          <li>
