  ...
  return (
    <>
      <div className={styles.textBox}>
        ...
        />
        <p>
          ※実戦では4面子1雀頭揃えてもアガリにはならないことがあります。テンパイしているときに
        ...
        <p>
          ...
          <strong>ロン</strong>
          されてしまい、点を失ってしまうからです。そこで、「この手牌はアガれない」と思ったらロンされない牌を切っていって守備に回る（オリる）ことが大切です。例えば、6巡目で局も中盤に差し掛かろうというときに以下の手牌だったとしましょう。
        </p>
        <img
        ...
        />
        <p>
          8巡目でこの手牌はあまりにも悪くてアガリは到底見えません。そこで、この局は基本的にはロンされにくい牌を抱えて、他家から立直が入ったら、ロンされにく牌を切っていく（
          <strong>オリていく</strong>
