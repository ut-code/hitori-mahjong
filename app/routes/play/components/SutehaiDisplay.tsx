import type { IndexedHai } from "@/types/game";
...
export function SutehaiDisplay({ indexedSutehai }: SutehaiDisplayProps) {
	return (
		<div>
			...
			<div className="grid grid-cols-6 gap-0 h-36 md:h-44 content-start bg-[#0F2918] rounded-md p-1 border border-[#1A472A] w-[13rem] md:w-[16rem]">
