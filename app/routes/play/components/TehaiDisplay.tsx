...
import type { GameState, IndexedHai } from "@/types/game";
...
function TehaiButton({ hai, discardFetcher }: TehaiButtonProps) {
	return (
		<discardFetcher.Form method="post" action="/play">
			<input type="hidden" name="intent" value="tedashi" />
...
function TsumoButton({
	...
	return (
		<discardFetcher.Form method="post" action="/play">
			<input type="hidden" name="intent" value="tsumogiri" />
			<button
				type="submit"
