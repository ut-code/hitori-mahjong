...
import { screenMentsuCount, compareInfo, incrementInfo, iterProduct, calculateSyantenFromCountInfo, MentsuCountInfo } from "../src/utils/calculateSyantenMentsu";
...
test("check: iterProduct", () => {
  expect(JSON.stringify(iterProduct(["1", "2"], ["a", "b"], ["x", "y", "z"]))).toBe(
    JSON.stringify(
      [
        ["1", "a", "x"],
        ["1", "a", "y"],
